...
![Alt text](./Hadoop24.png)
![Alt text](./Hadoop25.png)
![Alt text](./Hadoop26.png)
##### 2.2 Hadoop集群上程序设计
...
![Alt text](./Hadoop104.png)
![Alt text](./Hadoop103.png)
然后将数据集上传到文件夹中
![Alt text](./Hadoop105.png)
![Alt text](./Hadoop106.png)
...
![Alt text](./Hadoop44.png)
运行结果如下图所示：
![Alt text](./Hadoop45.png)
同样也是选择输出文件中末尾十行来展示，因为程序输出的是Unicode编码，所以我把它转换为utf-8编码之后如下图所示：
![Alt text](./Hadoop46.png)
![Alt text](./Hadoop47.png)
